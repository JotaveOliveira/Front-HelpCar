      ...
      <form class="text-center" @submit.prevent="salvar">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" placeholder="Ex.: São Paulo" id="inputCity" v-model="usuario.cidade"
              required>
          </div>
          <div class="form-group col-md-4">
            <label for="inputCity">Estado</label>
            <input type="text" class="form-control" placeholder="Ex.: São Paulo" id="inputCity" v-model="usuario.estado"
              required>
          </div>
          <div class="form-group col-md-2">
            <label for="inputZip">CEP</label>
            <input type="text" class="form-control" placeholder="Ex.: 00000-000" maxlength="9" id="inputZip"
              v-model="usuario.cep" required>
          </div>
        </div>
